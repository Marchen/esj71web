...
* Oral presentations will be held using Zoom Meetings. When the presentation time comes, the video files uploaded in advance will be played, and the real-time session for questions and answers will follow the presentation. Presentation files for oral presentations must be uploaded in advance through the conference platform (ONLINE CONF) before the presentation time. Please keep the file size within 500MB. Only MP4 file format is supported.
