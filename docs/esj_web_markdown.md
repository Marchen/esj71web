...
＜例＞
![ESJ71ロゴ](https://edit.esj-meeting.net/wp-content/uploads/2023/06/esj71_logo.png)
...
まだ何を設定すればいいのか把握し切れていないので、実際運用してみて変更した方がよい点が出てきたら随時加筆・修正予定ですが、とりあえず、以下のテンプレートのようなヘッダーを使ってみます。
